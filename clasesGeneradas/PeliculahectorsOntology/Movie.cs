...
using Genre = GenerohectorsOntology.Genre;
using Person = PersonahectorsOntology.Person;
...
namespace PeliculahectorsOntology
{
	...
	public class Movie : GnossOCBase
	{
		...
		[LABEL(LanguageEnum.en,"Actor")]
		[LABEL(LanguageEnum.es,"Actor")]
		...
		[LABEL(LanguageEnum.en,"Aggregated Rating")]
		[LABEL(LanguageEnum.es,"Valoraciones agregadas")]
		...
		[LABEL(LanguageEnum.en,"Production company")]
		...
		public override List<string> ToSearchGraphTriples(ResourceApi resourceAPI)
		{
			...
			AgregarTags(list);
			AgregarTripleALista($"http://gnoss/{ResourceID.ToString().ToUpper()}", "http://www.w3.org/1999/02/22-rdf-syntax-ns#type", $"\"peliculahectors\"", list, " . ");
		...
		{
			return $"{resourceAPI.GraphsUrl}items/PeliculahectorsOntology_{ResourceID}_{ArticleID}";
		}
