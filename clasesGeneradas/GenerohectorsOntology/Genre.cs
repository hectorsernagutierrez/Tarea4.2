...
namespace GenerohectorsOntology
{
	...
	public class Genre : GnossOCBase
	{
		...
		[LABEL(LanguageEnum.en,"Name of the genre")]
		[LABEL(LanguageEnum.es,"Nombre del género")]
		...
		{
			return $"{resourceAPI.GraphsUrl}items/GenerohectorsOntology_{ResourceID}_{ArticleID}";
		}
